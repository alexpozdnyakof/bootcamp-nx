    ...
    return (
        <Box
            ...
            style={{
                ...
                '--bootcamp-actionable-primary-destructive-idle-fill': '#d26160',
                '--bootcamp-actionable-primary-destructive-hover-tint': '#fff',
                '--bootcamp-actionable-primary-destructive-hover-fill': '#e98786',
                '--bootcamp-actionable-primary-destructive-disabled-tint': '#767777',
                '--bootcamp-actionable-primary-destructive-disabled-fill': '#7f2c24',
                /* secondary destructive button colors (no fill, as these are transparent and bordered) */
                '--bootcamp-actionable-secondary-destructive-idle-tint': '#f68584',
                '--bootcamp-actionable-secondary-destructive-hover-tint': '#eFa9a9',
                '--bootcamp-actionable-secondary-destructive-disabled-tint': '#8a5853',
            }}
        >
            <Template {...props} />
        </Box>
